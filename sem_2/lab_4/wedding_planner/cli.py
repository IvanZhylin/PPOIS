...
from wedding_planner.presentation.plan_formatter import format_plan_text
...
class WeddingPlannerCLI:
    ...
    def _show_plan(self) -> None:
        print()
        print(format_plan_text(self._service.plan))


def run_cli(data_file: str) -> None:
    """Создаёт CLI с JSON-хранилищем и запускает его."""
    try:
